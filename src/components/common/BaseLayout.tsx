  ...
  return (
    <div className="relative flex flex-col flex-1 bg-[#F6F6FC] min-h-screen max-h-screen overflow-hidden">
      ...
      <main
        ...
        <div className="flex-1 min-h-screen overflow-y-auto  h-full object-left-20 bg-no-repeat w-full lg:w-4/5  bg-cover absolute right-0 top-0 -z-0  bg-[url(assets/images/bg1.png)]">
          {
            openSideBar && (
              <div

                className="fixed w-full h-full inset-0 bg-gray-900 opacity-75"
