...
const StashHousePage = (props: Props) => {
    return (
        <div>
            <div className="w-full py-20 relative flex flex-col justify-center items-center -z-10 gap-8 mt-8 lg:mt-0">
                ...
                <div className="flex justify-center items-center w-full pt-6">
                    <button className="Dashboard_button__ct62Q font-medium w-3/4 py-2 rounded-sm relative z-10">Approve</button>
                </div>
                </div>
                </div>
                <h1 className="Dashboard_heading__SF4VX font-pricedown text-4xl md:text-6xl text-white relative pb-4 mb-4">your staking</h1>
                ...
                <div className="flex justify-center items-center w-full pt-6 gap-4">
                    <div className="flex flex-col w-3/4">
                        ...
                        <button className="Dashboard_button__ct62Q font-medium w-full py-2 rounded-sm relative z-10">Compound</button>
                    </div>
                <div className="flex flex-col w-3/4">
                    <p className="opacity-50 text-right">10% tax</p>
                    <button className="Dashboard_button__ct62Q font-medium w-full py-2 rounded-sm relative z-10">Claim</button>
                </div>
                </div>
                </div>
